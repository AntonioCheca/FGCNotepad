        ...
        <AppContainer maxWidth={false}>
            ...
            <div style={{display: "grid", gap: 12, marginBottom: 24, border: "1px solid #e5e5e5", borderRadius: 8, padding: 12}}>
                ...
                <AppTypography variant="body2">
                    Set how scenario values are calculated when you open a scenario page.
                </AppTypography>

                <div style={{display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap"}}>
                    <span style={{display: "inline-flex", alignItems: "center", gap: 6}}>
                        <AppTypography variant="body2">My Current Knowledge</AppTypography>
                        <AppTooltip title="Use only combos you marked as known in Combo Knowledge.">
                    ...
                    <span style={{display: "inline-flex", alignItems: "center", gap: 6}}>
                        ...
                        <AppTooltip title="Use a practical default combo pool for quick browsing and guest mode.">
                            <span style={{display: "inline-flex", cursor: "help"}}>
                                <HelpOutlineOutlinedIcon fontSize="small"/>
                            </span>
                        </AppTooltip>
                    ...
                    <span style={{display: "inline-flex", alignItems: "center", gap: 6}}>
                        ...
                        <AppTooltip title="Include all combos with difficulty less than or equal to your selected cap.">
                            <span style={{display: "inline-flex", cursor: "help"}}>
                                <HelpOutlineOutlinedIcon fontSize="small"/>
                            </span>
                        </AppTooltip>
                ...
                <div style={{display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap"}}>
                    ...
                    {executionSelection.mode === "difficulty_cap" ? (
                        <select
                            ...
                            onChange={(event) => {
                                ...
                                setExecutionSelection((current) => ({
                                    ...current,
                                    difficultyCap: Number.isFinite(cap) ? cap : 3,
                                }));
                            }}
                            style={{height: 38, borderRadius: 6, border: "1px solid #d9d9d9", padding: "0 10px"}}
                        >
                        ...
                        onClick={async () => {
                            ...
                            try {
                                ...
                                setExecutionSelection({
                                    ...
                                    difficultyCap: updated.difficultyCap,
                                });
                    ...
                    >
                        {savingPreference ? "Saving..." : "Save Mode"}
                    </AppButton>
                </div>
            </div>
            ...
            <div style={{display: "grid", gap: 12, border: "1px solid #e5e5e5", borderRadius: 8, padding: 12}}>
                ...
                <div style={{display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap"}}>
                    ...
                    <AppButton type="button" variant="outlined" onClick={() => {
                        setCombos((current) => current.map((combo) => ({...combo, known: true})));
                    }}>
                        Mark All Known
                    </AppButton>

                    <AppButton type="button" variant="outlined" onClick={() => {
                        setCombos((current) => current.map((combo) => ({...combo, known: false})));
                    }}>
                        Clear All
                    </AppButton>
                    ...
                    <select
                        ...
                        onChange={(event) => {
                            ...
                            setCombos((current) => current.map((combo) => ({
                                ...combo,
                                known: combo.difficultyLevel !== null && combo.difficultyLevel <= cap,
                            })));
                        }}
                        style={{height: 38, borderRadius: 6, border: "1px solid #d9d9d9", padding: "0 10px"}}
                    >
                    ...
                    <select
                        ...
                        onChange={(event) => {
                            ...
                            setDifficultyFilter(Number.isFinite(parsed) ? parsed : null);
                        }}
                        style={{height: 38, borderRadius: 6, border: "1px solid #d9d9d9", padding: "0 10px"}}
                    >
                    ...
                    <AppButton
                        type="button"
                        disabled={savingKnowledge || !selectedCharacterId}
                        onClick={async () => {
                            ...
                            setSaveMessage(null);
                            try {
                                await updateComboKnowledge(
                                    selectedCharacterId,
                                    combos.filter((combo) => combo.known).map((combo) => combo.id)
                                );
                ...
                <div style={{display: "grid", gap: 6}}>
                    ...
                    {combos
                        .filter((combo) => {
                            ...
                            return combo.difficultyLevel !== null && combo.difficultyLevel <= difficultyFilter;
                        })
                        .map((combo) => (
                        <label
                            key={combo.id}
                            ...
                            <span style={{display: "flex", alignItems: "center", gap: 8}}>
                                <input
                                    ...
                                    onChange={(event) => {
                                        ...
                                        setCombos((current) => current.map((row) =>
                                            row.id === combo.id ? {...row, known: checked} : row
                                        ));
                                    }}
                                />
