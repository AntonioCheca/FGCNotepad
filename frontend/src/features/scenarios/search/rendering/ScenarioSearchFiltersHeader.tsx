    ...
    return (
        <AppStack direction="row" alignItems="flex-start" justifyContent="space-between" sx={{gap: 1, flexWrap: "wrap"}}>
            <AppBox sx={{display: "grid", gap: 0.15}}>
                ...
                <AppTypography variant="body2" color="text.secondary" sx={{display: {xs: "none", md: "block"}}}>Attacker and trigger move are prioritized for practical matchup lookup speed.</AppTypography>
            </AppBox>
