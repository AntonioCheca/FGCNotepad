...
# 3. Limpieza fuerte del código antes de hacerlo público

## Objetivo

Reducir señales de código improvisado, frágil o claramente generado sin criterio.

## Problemas detectados

- Código inconsistente entre etapas antiguas y nuevas
- Patrones repetidos
- Comentarios feos o residuales
- Nombres débiles
- Componentes demasiado grandes
- Estructura poco defendible open source
...
- Lógica duplicada
- Hooks mezclados con UI
- Estados innecesarios
- Naming inconsistente

### Backend

- Servicios demasiado cargados
...
Eliminar restos tipo:

- comentarios AI raros
- TODOs basura
- código muerto
- logs temporales
- hacks evidentes
...
- Revisión global completada
- Issues graves corregidos
- Código más legible
- Repo presentable
- Sin residuos vergonzosos evidentes

---

# PRIORIDAD P1 — Muy importante para valor del producto

No bloquean deploy técnico, pero sí la calidad central del sistema.
